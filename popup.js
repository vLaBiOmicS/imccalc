document.addEventListener('DOMContentLoaded', function() {
    ...
    setTheme(savedTheme); // Aplica o tema salvo ao carregar
    ...
    // Adiciona o evento de cálculo de IMC
    document.getElementById('calculate-bmi').addEventListener('click', function() {
        ...
        // Persistir os dados no IndexedDB
        persistCalculation(bmi, weight, height, classification);
    });

    // Eventos para exportar CSV e apagar banco de dados
    const exportLink = document.getElementById('export-csv');
    const deleteLink = document.getElementById('delete-db');

    if (exportLink) {
        exportLink.addEventListener('click', exportToCSV);
    }

    if (deleteLink) {
        deleteLink.addEventListener('click', clearDatabase);
    }
});
...
// Função para persistir os dados do cálculo de IMC no IndexedDB
...
// Função para exportar os dados persistidos para CSV
...
// Função para apagar os dados do IndexedDB
